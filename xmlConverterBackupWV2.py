...
def main():
  ...
  for fyml in ymlfiles:
    ...
    print (fyml)
    try:
      xml_string = render_template(mcf_string, schema_local=template_dataset_eng)
  ...
  '''mcf_string = 'data.yml'
  xml_string = render_template(mcf_string, schema_local='/home/nemanja/myProject/pygeometa/pygeometa/templates/n/')
  #print(xml_string)
  with open('output4.xml', 'w') as ff:
    ff.write(xml_string)'''
